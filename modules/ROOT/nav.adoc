...
*** {sgw--xref}{access--page}[Access]
*** {sgw--xref}{access-model--page}[Access Model]
...
*** {access-control-how-add-roles-to-users--xref}
*** {access-control-how-allow-access--xref}
*** {access-control-how-inspect-access--xref}
*** {access-control-how-write-access--xref}
** {sgw--xref}{sync-function-api--page}[Sync Function API]
...
** {sgw--xref}sync-function-from-sync-nav.adoc[Sync Function]
** {revisions--xref}
