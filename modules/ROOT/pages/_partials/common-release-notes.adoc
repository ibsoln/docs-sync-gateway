...
:xref-sgw-bmk-cfg-dbsvr: xref:{configuration-properties--pfx}#databases-this_db-server[Couchbase Server Connection String]
:xref-sgw-bmk-cfg-hideprodvn: xref:{configuration-properties--pfx}#hide_product_version[Hide Product Version in Headers]
