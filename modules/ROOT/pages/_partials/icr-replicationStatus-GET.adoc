...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replication-status-req-all]
----
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replication-status-resp-all]
----
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replication-status-req]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replication-status-resp]
----
--
