...
:xref-sgw-ep-admin-api-replication-repstatus-query: {xref-sgw-pfx-admin-api-replication}/get__db___replicationStatus__queryString_[_replicationStatus?{querystring}]
...
:xref-sgw-pfx-config-properties-db-rep: {xref-sgw-pg-config-properties-db}-this_db-replications-this_rep-
:xref-sgw-pg-config-properties-db-replications: {xref-sgw-pfx-config-properties-db-rep}[replications]
...
:xref-sgw-pg-icr-admin: {xref-sgw-pfx-icr-admin}[Replication Admin]
...
:xref-sgw-pg-icr-conflict-resolution-auto: {xref-sgw-pfx-icr-conflict-resolution}#automatic-conflict-resolution[Conflict Resolution]
:xref-sgw-pfx-icr-high-availability: {xref-pfx-sgw}{sgw-pg-icr-high-availability}
:xref-sgw-pg-icr-high-availability: {xref-sgw-pfx-icr-high-availability}[High-Availability]
...
:xref-sgw-pg-icr-monitoring: {xref-sgw-pfx-icr-monitoring}[Replication Monitoring]
...
:xref-sgw-pg-icr-sgreplicate: {xref-sgw-pfx-icr-sgreplicate}[Inter-cluster Replication]
:xref-sgw-pg-icr-sgreplicate-init: {xref-sgw-pfx-icr-sgreplicate}#initialization[Introducing Inter-cluster Replication -- Initialization]
:xref-sgw-pg-icr-sgreplicate-sgr1: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr1}[ICR with SGR-1]
:xref-sgw-pg-icr-sgreplicate-sgr2: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr2}[ICR with SGR-2]
...
:xref-sgw-pg-icr-running: {xref-pfx-sgw}{sgw-pg-icr-running}[Replication Initialization]
...
:xref-sgw-pg-stats-monitoring: {xref-pfx-sgw}{sgw-pg-stats-monitoring}[Stats and Monitoring]
