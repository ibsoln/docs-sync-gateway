...
:xref-sgw-pg-adv-rest-api-client: {xref-pfx-sgw}{sgw-pg-adv-rest-api-client}[How do I use the REST API?]
// [Use the REST API?]
:xref-sgw-pg-adv-sgw-cfg-import-filter: {xref-pfx-sgw}{sgw-pg-adv-sgw-cfg-import-filter}[How do I use Import filters?]
// [Work With Import Filters]
:xref-sgw-pg-adv-sgw-cfg-sync-function: {xref-pfx-sgw}{sgw-pg-adv-sgw-cfg-sync-function}[How do I use Sync functions?]
...
:xref-sgw-ep-admin-api-replication-post: {xref-sgw-pfx-admin-api-replication-post}[POST/{url}/{db}/_replication/example-rep-db1]
:xref-sgw-ep-admin-api-replication-post-remote: {xref-sgw-pfx-admin-api-replication-post}[remote]


// _replication PUT
:xref-sgw-ep-admin-api-replication-put: {xref-sgw-pfx-admin-api-replication}/put__db___replication__replicationID_[PUT/{url}/{db}/_replication/example-rep-db1]

// _replication DELETE
:xref-sgw-ep-admin-api-replication-delete: {xref-sgw-pfx-admin-api-replication}/delete__db___replication__replicationID_[DELETE/{url}/{db}/_replication/example-rep-db1]
...
:xref-sgw-ep-admin-api-replication-repstatus-set: {xref-sgw-pfx-admin-api-replication}/put__db___replicationStatus__replicationID__action__action_[_replicationStatus(replicationID)?action={action}]
...
:xref-sgw-pg-icr-admin: {xref-sgw-pfx-icr-admin}[ICR -- How are replications managed?]
// [Replication Admin]
...
:xref-sgw-pg-icr-conflict-resolution: {xref-sgw-pfx-icr-conflict-resolution}[ICR -- How are conflicts handled?]
// [Conflict Resolution]
:xref-sgw-pg-icr-conflict-resolution-auto: {xref-sgw-pfx-icr-conflict-resolution}#automatic-conflict-resolution[How does Conflict Resolution work?]
// [Conflict Resolution]
:xref-sgw-pfx-icr-high-availability: {xref-pfx-sgw}{sgw-pg-icr-high-availability}
:xref-sgw-pg-icr-high-availability: {xref-sgw-pfx-icr-high-availability}[ICR -- What is High-Availability?]
// [High-Availability]
...
:xref-sgw-pg-icr-monitoring: {xref-sgw-pfx-icr-monitoring}[ICR -- What monitoring is available?]
...
:xref-sgw-pg-icr-sgreplicate: {xref-sgw-pfx-icr-sgreplicate}[What is inter-sync-gateway replication]
// [Inter-sync-gateway Replication]
:xref-sgw-pg-icr-sgreplicate-init: {xref-sgw-pfx-icr-sgreplicate}#initialization[ICR -- What is Initialization]
:xref-sgw-pg-icr-sgreplicate-sgr1: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr1}[ICR -- What does SGR-1 provide?]
:xref-sgw-pg-icr-sgreplicate-sgr2: {xref-pfx-sgw}{sgw-pg-icr-sgreplicate-sgr2}[ICR -- What does SGR-2 provide?]
// :xref-sgw-pg-icr-overview: {xref-pfx-sgw}{sgw-pg-icr-overview}[Inter-Cluster Replication]
:xref-sgw-pg-icr-overview: {xref-sgw-pg-icr-sgreplicate}[Inter-Cluster Replication]
:xref-sgw-pg-icr-overview--intro: {xref-pfx-sgw}{sgw-pg-icr-overview}#introduction[Introducing Inter-Cluster Replication]
:xref-sgw-pg-icr-running: {xref-pfx-sgw}{sgw-pg-icr-running}[ICR -- How do I create/run?]
...
:xref-sgw-pg-logging: {xref-pfx-sgw}{sgw-pg-logging}[How do I manage logs?]
// [Logging]
...
:xref-sgw-pg-sgcollect-info: {xref-pfx-sgw}{sgw-pg-sgcollect-info}[How to I use SGCollect Info?]
// [SGCollect Info]
:xref-sgw-pg-shared-bucket-access: {xref-pfx-sgw}{sgw-pg-shared-bucket-access}[Syncing Mobile and Server]
:xref-sgw-pg-stats-monitoring: {xref-pfx-sgw}{sgw-pg-stats-monitoring}[How do  I manage Stats and Monitoring?]
