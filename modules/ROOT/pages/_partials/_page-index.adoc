...
:configuration-schema-database--xref-enable-shared-bucket-access: {sgw--xref}{configuration-schema-database--page}#databases-this_db-user_xattr_key[enable_shared_bucket_access]
