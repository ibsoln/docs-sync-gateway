...
:xref-sgw-pg-icr-sgreplicate-init: {xref-sgw-pfx-icr-sgreplicate}#initialization[Initialization of Inter-sync-gateway replications]
...
:xref-sgw-pg-icr-overview: {xref-sgw-pg-icr-sgreplicate}[Inter-sync-gateway Replication]
...
:xref-sgw-pg-stats-monitoring: {xref-pfx-sgw}{sgw-pg-stats-monitoring}[Use Sync Gateway Statistics]
