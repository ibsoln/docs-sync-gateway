...
:access--control-model--xref: {sgw--xref}{access--control-model--page}[Access]
...
:access-control-how-add-roles-to-users--xref: {sgw--xref}{access-control-how-add-roles-to-users--page}[Assign Roles to Users]
...
:access-control-how-inspect-access--xref: {sgw--xref}{access-control-how-inspect-access--page}[Verify Access]
...
:access-control-model--page: access-control-model.adoc
:access-control-model--xref: {sgw--xref}{access-control-model--page}[Access Model]
...
:sync-function--xref: {sgw--xref}{sync-function--page}[Sync Function Overview]
