...
:access--page: access.adoc
:access--xref: {sgw--xref}{access--page}[Access]
...
:access-control-how-add-roles-to-users--page: access-control-how-add-roles-to-users.adoc
:access-control-how-add-roles-to-users--xref: {sgw--xref}{access-control-how-add-roles-to-users--page}[Add a Role to a User]
:access-control-how-allow-access--page: access-control-how-allow-access.adoc
:access-control-how-allow-access--xref: {sgw--xref}{access-control-how-allow-access--page}[Allow Access]
:access-control-how-create-roles--page: access-control-how-create-roles.adoc
:access-control-how-create-roles--xref: {sgw--xref}{access-control-how-create-roles--page}[Create a Role]
:access-control-how-create-users--page: access-control-how-create-users.adoc
:access-control-how-create-users--xref: {sgw--xref}{access-control-how-create-users--page}[Create a User]
:access-control-how-inspect-access--page: access-control-how-inspect-access.adoc
:access-control-how-inspect-access--xref: {sgw--xref}{access-control-how-inspect-access--page}[Inspect Access]
...
:access-model--page: access-model.adoc
:access-model--xref: {sgw--xref}{access-model--page}[Access Model]
...
:rest-api-admin-doc-channels-get--xref: {rest-api-admin--pfx}#get__db___all_docs
