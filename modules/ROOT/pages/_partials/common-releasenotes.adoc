...
Metrics REST API::
// tag::prometheus-281[]
This release see the general availability of Couchbase Sync Gateway's Metrics REST API, which was introduced as a _developer preview_ in release 2.8.0.
This feature exposes Sync Gateway's extensive stats in either JSON and Prometheus compatible format.
...
This customization of responses avoids revealing the version of the Sync Gateway to HTTP requests to the root path.
...
// tag::fixed-281[]
.List of issues resolve by this release
[#tbl-fixed,cols="^2,8"]
...
|https://issues.couchbase.com/browse/[CBG-1179]
|https://issues.couchbase.com/browse/[2.8.1 Backport ISGR Websocket errors contain unredacted basic auth components]

|https://issues.couchbase.com/browse/[CBG-1263]
|https://issues.couchbase.com/browse/[2.8.1 Backport CBG-1222 - Pre-2.8 cbgt index definitions not being removed post-upgrade]


|https://issues.couchbase.com/browse/[CBL-1406]
|https://issues.couchbase.com/browse/[Update to 2.8 causes data to vanish]

|https://issues.couchbase.com/browse/[CBG-1203]
|https://issues.couchbase.com/browse/[2.8.1 Backport CBG-1194 - sgcollect_info not collecting system information]

|https://issues.couchbase.com/browse/[SPY-84]
|https://issues.couchbase.com/browse/[Add 2.8.1 spymemcached-test jars to maven repo]

|https://issues.couchbase.com/browse/[CBG-1221]
|https://issues.couchbase.com/browse/[2.8.1 Backport Include wanted node defs when building heartbeat node set]

|https://issues.couchbase.com/browse/[CBG-1252]
|https://issues.couchbase.com/browse/[2.8.1 Backport CBG-1246 - Changes limit incorrectly applied in case of CBG-946]

|https://issues.couchbase.com/browse/[CBG-1234]
|https://issues.couchbase.com/browse/[2.8.1 Backport CBG-1231 - Prevent import cfg startup races]

|https://issues.couchbase.com/browse/[CBG-1265]
|https://issues.couchbase.com/browse/[2.8.1 Backport CBG-1163 - Missing document in changes feed when using a compound sequence number as since parameter]

|https://issues.couchbase.com/browse/[CBG-1214]
|https://issues.couchbase.com/browse/[2.8.1 Backport Calling DELETE on non-existent document creates non-tombstone]

|https://issues.couchbase.com/browse/[CCBC-768]
|https://issues.couchbase.com/browse/["Analytics closes the socket after query]

|https://issues.couchbase.com/browse/[CCBC-813]
|https://issues.couchbase.com/browse/[cbc-pillowfight don't always end up with the correct number of documents]

|https://issues.couchbase.com/browse/[CCBC-842]
|https://issues.couchbase.com/browse/[libcouchbase v2.8.0 : Unable to set a subdoc as a user with data writer role on a bucket]
|===
// end::fixed-281[]
