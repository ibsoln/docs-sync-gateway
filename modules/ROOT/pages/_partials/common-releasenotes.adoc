...
|https://issues.couchbase.com/browse/CBG-1313[CBG-1313]
|https://issues.couchbase.com/browse/CBG-1313[2.8.1 Backport --  Expose metrics API on 127.0.0.1:4986 by default]
|===
...
|https://issues.couchbase.com/browse/CBG-1214[CBG-1214]
|https://issues.couchbase.com/browse/CBG-1214[2.8.1 Backport Calling DELETE on non-existent document creates non-tombstone]

|https://issues.couchbase.com/browse/CBG-1221[CBG-1221]
|https://issues.couchbase.com/browse/CBG-1221[2.8.1 Backport -- Include wanted node defs when building heartbeat node set]
