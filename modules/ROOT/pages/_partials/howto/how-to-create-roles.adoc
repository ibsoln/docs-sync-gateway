...
Create and-or manage roles using the Sync Gateway Admin REST API -- {rest-api-admin--xref}.

If you are running Sync gateway in static mode then you can also configure roles within the Sync Gateway Static Configuration File -- {configuration-schema-static--xref}
