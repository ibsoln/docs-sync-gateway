...
=== DNSGW-2.8/001 SG-Replicate 1.0 replication protocol
// tag::dnsgw-28-001-sgr1-announce[]
SG-Replicate 1.0 (SGR-1) is deprecated in Sync Gateway versions starting with version {version}. You should plan your transition to SGR-2 now to avoid potential issues when this functionality is removed.
// end::dnsgw-28-001-sgr1-announce[]

// tag::dnsgw-28-001-sgr1-impact[]
The functionality of SG-Replicate 1.0 remains unchanged, unless explicitly stated in these release notes and-or in the appropriate documentation section.
