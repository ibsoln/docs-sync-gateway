...
You should refer to {configuration-properties-xref} for details on the configuration options.
The install itself contains example configuration files -- see the appropriate install section for details on their location.
