...
They respond to network issues such as lost connections, by applying a persistent exponential backoff policy to attempt reconnection  (see max_backoff_time).
