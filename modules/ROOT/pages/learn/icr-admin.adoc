...
:param-abstract: Use it to learn how to manage and monitor inter-cluster replications
...
// [source, json]
// ----
// include::{example-cfg}[tag=icr-rep-list-replications-req]
// ----
// --
...
// [source, json]
// ----
// include::{example-cfg}[tag=icr-rep-list-replications-body]
// ----
// --
...
// [source, json]
// ----
// include::{example-cfg}[tag=icr-rep-list-replications-resp]
// ----
// --
// ====
// =====
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replications-req]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replications-resp]
----
--
====
=====
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replications-req-all-for-db]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-retrieve-replications-resp-all-for-db]
----
--
====
=====
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-update-replications-req]
----
--
+
Response::
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-update-replications-resp-200]
----
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-update-replications-resp-400]
----
--
====
=====
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-remove-replications-req]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-remove-replications-resp]
----
...
[source,javascript]
----
include::{example-cfg}[tag=icr-rep-cancel-replications-req]
----
--
+
...
// [source,javascript]
// ----
// include::{example-cfg}[tag=icr-rep-cancel-replications-body-no-id]
// ----
// --
//
Response::
...
[source,javascript]
----
include::{example-cfg}[tag=icr-rep-cancel-replications-resp]
----
--
====
=====
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-start-replications-req]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-start-replications-resp]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-stop-replications-req]
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-stop-replications-resp]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-reset-replications-req]
----
--
...
[source, json]
----
include::{example-cfg}[tag=icr-rep-reset-replications-resp]
----
--
====
=====
