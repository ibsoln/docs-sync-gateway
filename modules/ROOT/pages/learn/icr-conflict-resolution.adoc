...
include::example$configuration/sync-gateway-config.json[tags=icr-simple-own-winner-conflict-resolver]
--
Merge a Winner::
+
--
...
include::example$configuration/sync-gateway-config.json[tags=icr-simple-merge-conflict-resolver]
--
