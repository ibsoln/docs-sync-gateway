= How to Allow Access
:description: pass:q[How to allow a Sync Gateway user access to data in cloud-to-edge enterprise data synchronization.]
:idprefix:
:idseparator: -
...
include::{howto}allow-access.adoc[leveloffset=+0]
...
// You make dynamic user access grants in the sync function using the {sync-function-api-access-cmd--xref} method -- for more, see: {sync-func--xref-add-cmd--xref}.
