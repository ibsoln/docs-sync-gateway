...
// The `meta` object references an XATTR key designated as identifying access control and-or routing information -- see {access-control-how-use-xattrs-for-access-grants--xref}
