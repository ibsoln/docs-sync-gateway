...
* Data provisioning from a central to a regional data center -- <<lbl-prov-data>>
+
--
...
Her XDCR serves an important role in supporting Disaster Recovery (DR) and Data Migration, even though Sync Gateway is the operational replicator of choice for mobile data.
