...
Cloud-to-edge synchronization scenarios typically involve a hierarchy of couchbase mobile clusters, within which a large number of edge clusters sync with one or more clusters in cloud data centers.
