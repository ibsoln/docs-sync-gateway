= Access
:description: pass:q[About Sync Gateway data access and its role in secure cloud-to-edge enterprise data synchronization.]
...
include::{concepts}access-control.adoc[levelofset=+0]
