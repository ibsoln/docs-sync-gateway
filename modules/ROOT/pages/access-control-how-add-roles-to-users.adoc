...
:description: pass:q[How to add a _Role_ to a Sync Gateway _User_ for secure access control in cloud-to-edge enterprise data synchronization.]
:idprefix:
:idseparator: -
...
include::{howto}add-roles-to-users.adoc[leveloffset=+0]
