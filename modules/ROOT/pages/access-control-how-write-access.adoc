= How to Control Write Access
:description: pass:q[How to allow a Sync Gateway user write access to data in cloud-to-edge enterprise data synchronization.]
:idprefix:
:idseparator: -
...
include::{howto}write-access.adoc[leveloffset=+0]
